...
class product{
    ...
    public function update_product($product_name,$cartegory_id,$type_product_id,$color_id,$product_price,$product_promotion,$product_description,$product_img,$product_id){
        $query = "UPDATE tbl_product SET product_name = '$product_name',cartegory_id = '$cartegory_id',type_product_id = '$type_product_id',color_id = '$color_id',product_price = '$product_price',product_promotion = '$product_promotion',product_description = '$product_description',product_img = '$product_img' WHERE product_id ='$product_id'";
